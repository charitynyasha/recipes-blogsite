...
export const navSkills=[
  ...
  },
  {
    id: 3,
      text: (
      <>
      <div className="flex justify-center items-center"><span>Recepies</span></div>
      </>
      ),
    url: "/recipes",
    hasDropdown: true,
...

  {
    ...
    dropdownItems: [
      ...
      { id: 2, text: "SWEETS & DESSERTS DELIGHTS", url: "/books/sweets-and-desserts" },
      { id: 3, text: "EXPLORING FLAVORS:HOME COOKING", url: "/books/exploring-flavors" },
...
export const recipeImage = [
  {
   title:"BREAD",
   imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318118/bread_wtkt3p.avif"
  },
  {
    title:"APPETIZER",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318143/appetiser_qs63ca.avif"
  },
  {
    title:"BREAKFAST",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318174/breakfast_x36ku2.avif"
  },
  {
    title:"MAIN DISHES",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318206/main_dishes_lp9c24.avif"
  },
  {
    title:"HEALTHY",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318235/healthy_w9we2b.avif"
  },
  {
    title:"VEGETARIAN",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318310/green_vegetables_zfufbb.avif"
  },
  {
    title:"INSTANT POT",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318333/taco_xkqm4a.avif"

  },
  {
    title:"DESSERT",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757318403/dessert_ds9nu0.avif"
  }
...
export const cookBooks = [
  {
    ...
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757424936/healthy_living_sfmsi0.avif",
    desc:"Indulge in balanced and nourishing meals."
  },
  {
     title:"SWEETS & TREATS DELIGHTS",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757424905/sweets_uubkgp.avif",
    desc:"Saviour irresistibly sweet delighs."
  },
  {
     title:"EXPLORING FLAVORS:HOME COOKING",
    imgSrc:"https://res.cloudinary.com/dxcmuocjm/image/upload/v1757424853/exploring_o9crk8.avif",
...
export const popularRecipes = [
  {
    ...
    imgSrc:(
      <div className="h-[100px] w-[120px] rounded-2xl border-2 border-[#BCA067] bg-white">
        <img src="https://res.cloudinary.com/dxcmuocjm/image/upload/v1757508995/shrimp_rx2oed.avif" alt="" className="object-center object-cover rounded-2xl  h-full w-full"/>
      </div>
    ...
    imgSrc:(
      <div className="h-[100px] w-[215px]  ">
        <img src="https://res.cloudinary.com/dxcmuocjm/image/upload/v1757509026/caprese_skewers_vm7g3w.avif" alt="" className="w-full h-full object-cover object-center rounded-2xl border-2 border-[#BCA067]"/>
      </div>
    )
  ...
  },
   {
    ...
    imgSrc:(
      <div className="h-[100px] w-[160px]  ">
        <img src= "https://res.cloudinary.com/dxcmuocjm/image/upload/v1757509096/overnight_oats_ctbdox.avif" alt="" className="w-full h-full object-cover object-center rounded-2xl border-2 border-[#BCA067]"/>
      </div>
    )
  ...
  },
   {
    ...
    imgSrc:(
      <div className="h-[100px] w-[160px]">
        <img src="https://res.cloudinary.com/dxcmuocjm/image/upload/v1757509128/chocolate_avacado_jzycmr.avif" alt="" className="object-cover object-center h-full w-full rounded-2xl border-2 border-[#BCA067]"/>
      </div>
    )
